...
# Shared VLA embedding utilities (model loading, input prep, hidden-state
# extraction, pooling).  These used to be defined inline here; they now live
# in a common module so the denoising-consistency script can reuse them.
from vla_embedding_utils import (
    load_policy,
    prepare_inputs,
    extract_vlm_hidden_states,
    pool_embeddings,
    pool_region,
)
